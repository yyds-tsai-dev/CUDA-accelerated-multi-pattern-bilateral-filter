...
#define DEFAULT_OUTPUT_FILE "output/scalar_out.txt"
...
static void bilateral_filter_scalar(
    const float *src,
    float *dst,
    int width,
    int height,
...
static void run_bilateral_iterations(
    ...
    for (int iter = 0; iter < iterations; iter++) {
        bilateral_filter_scalar(src, dst, width, height, spatial, dxs, dys);
        float *tmp = src;
        src = dst;
        dst = tmp;
    }
...
static void print_summary(
    ...
    printf("============================================================\n");
    printf("implementation               = Scalar baseline\n");
    printf("input_file                   = %s\n", input_file);
    ...
    printf("============================================================\n");
    printf("part                         = Part 1\n");
    printf("execution_model              = Scalar RISC-V baseline\n");
